...
if __name__ == "__main__":
    ...
    parser.add_argument("--features", type=int, required=True, help="The total number of input features for the model.")
    parser.add_argument("--classes", type=int, required=True, help="The total number of output classes for the model.")
    parser.add_argument("--rounds", type=int, default=3, help="Total number of federated learning rounds.")
    parser.add_argument("--clients", type=int, default=1, help="Minimum number of clients required to start a round.")
